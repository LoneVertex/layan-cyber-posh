...
- 🎨 **Cyberpunk × Dracula Palette:** Carefully balanced palette using deep slate charcoal (`#282a36`), off-white (`#f8f8f2`), and neon pastels (cyan, purple, lime green, yellow, orange, coral red).
...
| `cyan` | `#8be9fd` | User & host session pill |
| `green` | `#50fa7b` | Current directory path pill & prompt pointer |
| `yellow` | `#f1fa8c` | Clean Git state & execution time pill |
| `orange` | `#ffb86c` | Dirty / behind Git status |
...
cp layan-cyber-posh/themes/layan-cyber.omp.* ~/.config/oh-my-posh/themes/
```
...
All three formats are identical in structure and behavior.
